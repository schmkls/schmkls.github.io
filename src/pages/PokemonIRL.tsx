    ...
    <Post>
      <Post.Card>
        ...
        <Post.Card.Body>
          ...
          insects, plants, and fungi — we just don't enjoy it enough. What if we
          turned that into a game?
        </Post.Card.Body>
        <Post.Card.Body>
      ...
      <Post.Card>
        ...
        <Post.Card>
          ...
          <Post.Card.Body>
            ...
            able to comment on each other's catches to help identify uncertain
            species, share knowledge, and cheer each other on. Community
            interaction is a tool for collaboration, not enforcement.
          </Post.Card.Body>
        </Post.Card>
      </Post.Card>
    </Post>
